        ...
        'math':function(context){
            ...
            self.initialize = function(){
                ...
                let body=`<div class="form-group">
                    ...
                    <p>Input <a href="https://khan.github.io/KaTeX/function-support.html" target=_blank">LaTeX markup</a> Dibawah Ini : </p>
                    <p><textarea class="note-latex form-control" rows="7" placeholder="Masukkan Functions. Ex : \\tilde{a}"></textarea></p><br />
                    <p>Preview: </p>
                    <div class="text-center mt-2" style="min-height:20px;color:black;"><span class="note-math-dialog"></span></div>
                    ...
                    for(var i=0;i<latexSpan.length;i++){
                    ...
                    function renderMath(){
                        ...
                        try {
                            for(var i=0;i<mathSpan.length;i++){
                ...
                self.$dialog=ui.dialog({
                    ...
                    body:body,
                    footer:'<button class="btn btn-block btn-primary note-math-btn">'+lang.math.ok+'</button>'
