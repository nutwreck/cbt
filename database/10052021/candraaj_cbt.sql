...
-- Dumping data for table candraaj_cbt.bank_soal: ~55 rows (approximately)
...
-- Dumping data for table candraaj_cbt.config_buku_group: ~1 rows (approximately)
...
-- Dumping data for table candraaj_cbt.jawaban: ~176 rows (approximately)
...
REPLACE INTO `jawaban` (`id`, `bank_soal_id`, `order`, `name`, `score`, `is_key`, `created_datetime`, `updated_datetime`, `is_enable`) VALUES
	...
	(192, 73, 1, '<p>1<br></p>', 0, 0, '2021-05-04 14:29:25', NULL, 1),
	(193, 73, 2, '<p>0<br></p>', 0, 0, '2021-05-04 14:29:25', NULL, 1),
	(194, 73, 3, '<p>-5<br></p>', 0, 0, '2021-05-04 14:29:25', NULL, 1),
	(195, 73, 4, '<p>5<br></p>', 1, 1, '2021-05-04 14:29:25', NULL, 1),
...
-- Dumping data for table candraaj_cbt.pembahasan: ~37 rows (approximately)
...
REPLACE INTO `pembahasan` (`id`, `bank_soal_id`, `url`, `pembahasan`, `created_datetime`, `updated_datetime`, `is_enable`) VALUES
	...
	(38, 73, '', '', '2021-05-04 14:29:25', NULL, 1),
...
REPLACE INTO `sesi_pelaksanaan` (`id`, `paket_soal_id`, `name`, `mode_peserta_id`, `waktu_mulai`, `lama_pengerjaan`, `batas_pengerjaan`, `blok_layar`, `is_fleksible`, `is_hasil`, `is_ranking`, `is_pembahasan`, `is_komposisi_soal`, `created_datetime`, `updated_datetime`, `is_enable`) VALUES
	...
	(2, 10, 'Sesi Ujian Tes TOEFL', 2, '2021-05-06 21:00:00', 360, '2021-05-10 18:00:00', 1, 1, 1, 1, 1, 1, '2021-04-24 08:31:06', NULL, 1);
...
REPLACE INTO `ujian` (`id`, `sesi_pelaksanaan_id`, `paket_soal_id`, `user_id`, `user_no`, `user_name`, `user_email`, `list_soal`, `list_jawaban`, `jml_benar`, `jml_salah`, `jml_ragu`, `jml_kosong`, `skor`, `tgl_mulai`, `tgl_selesai`, `status`, `created_datetime`, `updated_datetime`, `is_enable`) VALUES
	...
	(52, 2, 10, 30, '202104190337', 'Temam Murbianto', 'lucknutdev@gmail.com', '6|45,6|44,7|48,7|50,8|52,8|51,10|57,10|55,11|60,11|61,13|66,13|65,14|67,14|68', '5|45||N|0|0,5|44||N|0|0,5|48||N|0|0,5|50||N|0|0,5|52||N|0|0,5|51||N|0|0,9|57||N|0|0,9|55||N|0|0,9|60||N|0|0,9|61||N|0|0,12|66||N|0|0,12|65||N|0|0,12|67||N|0|0,12|68||N|0|0', 0, 0, 0, 0, 0.00, '2021-05-09 19:45:39', '2021-05-10 01:45:39', 0, '2021-05-09 19:45:39', NULL, 1);
...
-- Dumping data for table candraaj_cbt.ujian_skor: ~2 rows (approximately)
