...
-- Dumping data for table candraaj_cbt.config_buku: ~0 rows (approximately)
...
REPLACE INTO `peserta` (`id`, `user_id`, `lembaga_id`, `no_peserta`, `group_peserta_id`, `name`, `file`, `created_datetime`, `updated_datetime`, `is_lock`, `is_enable`) VALUES
	(3, 6, 2, '202103310001', 1, 'Candra Aji Pamungkas', '', '2021-03-31 15:49:00', '2021-04-01 15:16:08', 0, 1),
	(4, 7, 2, '202103310001', 0, 'Fakhrul Zami', '', '2021-03-31 15:57:11', '2021-04-01 15:09:52', 0, 1),
	(8, 17, 2, '202104010001', 10, 'Imanuel', '', '2021-04-06 13:55:30', NULL, 1, 1),
	(9, 18, 2, '202104010002', 10, 'Sebastian', '', '2021-04-06 13:55:31', NULL, 1, 1),
	(10, 19, 2, '202104010003', 10, 'Tortelli', '', '2021-04-06 13:55:31', NULL, 0, 1),
	(11, 20, 2, '202104010004', 10, 'Manungga', '', '2021-04-06 13:55:31', NULL, 0, 1),
	(12, 21, 2, '202104010005', 10, 'Kito', '', '2021-04-06 13:55:31', NULL, 0, 1),
	(13, 22, 2, '202104010006', 10, 'Juki', '', '2021-04-06 13:55:31', NULL, 0, 1),
	(14, 23, 2, '202104010007', 10, 'Koli', '', '2021-04-06 13:55:31', NULL, 0, 1),
	(15, 24, 2, '202104010008', 10, 'Kulz', '', '2021-04-06 13:55:31', NULL, 0, 1),
	(16, 25, 2, '202104010009', 10, 'Afanda', '', '2021-04-06 13:55:31', NULL, 0, 1),
	(17, 26, 2, '202104010010', 10, 'Dimas', '', '2021-04-06 13:55:32', NULL, 0, 1),
	(18, 17, 2, '202104120003', 10, 'Imanuel', '', '2021-04-12 08:51:26', NULL, 0, 1),
	(19, 18, 2, '202104120004', 10, 'Sebastian', '', '2021-04-12 08:51:26', NULL, 0, 1);
...
REPLACE INTO `sesi_pelaksanaan` (`id`, `paket_soal_id`, `name`, `mode_peserta_id`, `waktu_mulai`, `lama_pengerjaan`, `batas_pengerjaan`, `blok_layar`, `is_fleksible`, `is_hasil`, `is_ranking`, `is_pembahasan`, `is_komposisi_soal`, `created_datetime`, `updated_datetime`, `is_enable`) VALUES
	(1, 6, 'Sesi Ujian Grandsbmptn 2021', 1, '2021-04-18 16:30:00', 360, '2021-04-18 22:30:00', 1, 0, 1, 1, 1, 1, '2021-04-16 16:37:53', '2021-04-16 23:07:41', 1);
...
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=latin1 COMMENT='untuk detail peserta ada di tabel peserta\r\nuntuk detail lembaga ada di tabel lembaga';

-- Dumping data for table candraaj_cbt.user: ~13 rows (approximately)
...
CREATE TABLE `v_sesi_pelaksanaan` (
	...
	`fleksible_name` VARCHAR(9) NOT NULL COLLATE 'utf8mb4_general_ci',
