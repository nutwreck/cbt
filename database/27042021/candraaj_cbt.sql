...
-- Dumping data for table candraaj_cbt.bacaan_soal: ~4 rows (approximately)
...
-- Dumping data for table candraaj_cbt.group_soal: ~15 rows (approximately)
...
REPLACE INTO `group_soal` (`id`, `paket_soal_id`, `parent_id`, `konversi_skor_id`, `kode_group`, `name`, `petunjuk`, `file`, `tipe_file`, `is_parent`, `is_continuous`, `created_datetime`, `updated_datetime`, `is_enable`) VALUES
	...
	(13, 10, 12, 5, 'QUESTION1-4', 'Questions 1-4', '', NULL, NULL, 0, 0, '2021-04-24 07:16:21', '2021-04-24 07:16:41', 1),
	(14, 10, 12, 5, 'QUESTIONS4-8', 'Questions 4-8', '', NULL, NULL, 0, 0, '2021-04-24 07:17:02', NULL, 1);
...
REPLACE INTO `invoice` (`id`, `invoice_number`, `payment_method_id`, `payment_method_name`, `payment_method_detail_id`, `payment_method_detail_name`, `user_id`, `user_name`, `user_email`, `user_no_telp`, `buku_id`, `invoice_total_cost`, `kode_unik`, `invoice_date_create`, `invoice_date_expirate`, `invoice_date_update`, `confirm_image`, `status`, `created_datetime`, `updated_datetime`, `is_enable`) VALUES
	(2, '202104220001', 1, 'BANK', 2, 'BANK BRI - 82893982938', 25, 'Afanda', 'afanda@gmail.com', '0828576857485', 2, 45300, 300, '2021-04-22 23:00:18', '2021-04-23 23:00:21', NULL, '26022100005_image.jpg', 0, '2021-04-22 23:00:30', NULL, 1);
...
-- Dumping data for table candraaj_cbt.jawaban: ~144 rows (approximately)
...
-- Dumping data for table candraaj_cbt.konversi_skor: ~4 rows (approximately)
...
-- Dumping data for table candraaj_cbt.pembahasan: ~29 rows (approximately)
...
REPLACE INTO `pembahasan` (`id`, `bank_soal_id`, `url`, `pembahasan`, `created_datetime`, `updated_datetime`, `is_enable`) VALUES
	...
	(10, 44, '', '', '2021-04-24 07:28:23', NULL, 1),
...
-- Dumping data for table candraaj_cbt.pengaturan_universal: ~7 rows (approximately)
...
REPLACE INTO `sesi_pelaksanaan` (`id`, `paket_soal_id`, `name`, `mode_peserta_id`, `waktu_mulai`, `lama_pengerjaan`, `batas_pengerjaan`, `blok_layar`, `is_fleksible`, `is_hasil`, `is_ranking`, `is_pembahasan`, `is_komposisi_soal`, `created_datetime`, `updated_datetime`, `is_enable`) VALUES
	...
	(2, 10, 'Sesi Ujian Tes TOEFL', 2, '2021-04-26 05:00:00', 360, '2021-04-28 17:38:00', 1, 1, 1, 1, 1, 1, '2021-04-24 08:31:06', NULL, 1);
...
-- Dumping data for table candraaj_cbt.sesi_pelaksanaan_user: ~13 rows (approximately)
...
REPLACE INTO `ujian` (`id`, `sesi_pelaksanaan_id`, `paket_soal_id`, `user_id`, `user_no`, `user_name`, `user_email`, `list_soal`, `list_jawaban`, `jml_benar`, `jml_salah`, `jml_ragu`, `jml_kosong`, `skor`, `tgl_mulai`, `tgl_selesai`, `status`, `created_datetime`, `updated_datetime`, `is_enable`) VALUES
	(27, 2, 10, 30, '202104190337', 'Temam Murbianto', 'lucknutdev@gmail.com', '6|46,6|44,7|50,7|49,8|53,8|51,10|58,10|57,11|60,11|62,13|66,13|65,14|68,14|69', '5|46|2|N,5|44|1|N,5|50|3|N,5|49|1|N,5|53||N,5|51||N,9|58|4|Y,9|57||N,9|60||N,9|62||N,12|66||N,12|65||N,12|68|3|N,12|69||N', 5, 1, 1, 8, 233.33, '2021-04-26 11:33:44', '2021-04-27 22:20:04', 1, '2021-04-26 11:33:45', '2021-04-27 20:09:14', 1),
	(28, 2, 10, 31, '202104190337', 'Temam Murbianto', 'lucknutdev@gmail.com', '6|46,6|44,7|50,7|49,8|53,8|51,10|58,10|57,11|60,11|62,13|66,13|65,14|68,14|69', '5|46|2|N,5|44|1|N,5|50|3|N,5|49|1|N,5|53||N,5|51||N,9|58|3|Y,9|57||N,9|60||N,9|62||N,12|66||N,12|65||N,12|68||N,12|69||N', 4, 10, 1, 9, 0.00, '2021-04-26 11:33:44', '2021-04-26 17:30:04', 1, '2021-04-26 11:33:45', NULL, 1);
...
REPLACE INTO `ujian_skor` (`id`, `ujian_id`, `group_soal_id`, `skor_original`, `skor_konversi`, `is_enable`, `created_datetime`) VALUES
	(40, 27, 5, 4, 28, 1, '2021-04-27 20:09:14'),
	(41, 27, 9, 0, 20, 1, '2021-04-27 20:09:14'),
	(42, 27, 12, 1, 22, 1, '2021-04-27 20:09:14');
