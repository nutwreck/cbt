<?php
$waktu_habis = strtotime('2021-03-18 19:34:40');
if(time() >= $waktu_habis)
{
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-center">
                            ...
                            <span class="sisawaktu font-arial-bold" data-intro="Sisa waktu pengerjaan anda." data-position="left" data-time="2021-03-18 19:34:40"></span>
                            <div class="row mt-3">
