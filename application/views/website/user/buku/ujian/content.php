                ...
                <div class="card">
                    <div class="card-body">
                        <table class="table table-hover">
                            <tbody>
                                <tr>
                                    <td>Nama Paket Soal</td><td>:</td><td><?=ucwords($paket_soal->nama_paket_soal)?></td>
                                </tr>
                                <tr>
                                    <td>Peserta</td><td>:</td><td><?=ucwords($this->session->userdata('peserta_name'))?> (<b><?=$this->session->userdata('no_peserta')?></b>)</td>
                                </tr>
                                <tr>
                                    <td>Materi</td><td>:</td><td><?=ucwords(strtolower($paket_soal->materi_name))?> - <b><?=$jumlah_soal-1?> Butir Soal</b></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
