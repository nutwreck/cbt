                ...
                <div class="card">
                    <div class="card-body">
                        <table class="table table-hover">
                            <tbody>
                                <tr>
                                    <td>Nama Tes</td><td>:</td><td><?=ucwords($paket_soal->nama_paket_soal)?></td>
                                </tr>
                                <tr>
                                    <td>Peserta</td><td>:</td><td><?=ucwords($this->session->userdata('peserta_name'))?> (<b><?=$this->session->userdata('no_peserta')?></b>)</td>
                                </tr>
                                <tr>
                                    <td>Materi</td><td>:</td><td><?=ucwords(strtolower($paket_soal->materi_name))?> - <b><?=$paket_soal->total_soal?> Butir Soal</b></td>
                                </tr>
                                <tr>
