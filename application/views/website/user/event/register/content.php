	...
	<div class="container">
		<div class="row py-3 mt-4 align-items-center">
			...
			<div class="col-md-7 col-lg-6 ml-auto">
				<form id="form_register" name="form_register" action="<?php echo base_url(); ?>website/user/Event/submit_register" class="form-register" method="POST" enctype="multipart/form-data" onsubmit="return(validate_register());">
				...
				<div class="text-center w-100">
					<p class="text-muted font-weight-bold fs-18">Sudah Punya Akun? <a href="<?= base_url() ?>event/login/<?= @$event->prefix_url ?>" class="text-primary ml-2 fs-18">Login</a></p>
				</div>
			</div>
		</div>
	</div>
