        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div id="content_add" class="col-sm-12 col-lg-6">
                    <div class="card">
                        <div class="card-header">Tambah Voucher</div>
                        <div class="card-body">
                            <form id="formadd" name="formadd" action="<?php echo base_url(); ?>website/lembaga/Management/submit_add_voucher" method="post" onsubmit = "return(validate_addform());">
                            <input type="hidden" id="csrf-hash-form" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none">
                                <div class="form-group">
                                    ...
                                    <input id="voucher" name="voucher" type="text" class="form-control" aria-required="true" aria-invalid="false" placeholder="Masukkan Kode Voucher">
                                </div>
                                <div class="form-group">
                                    ...
                                    <input id="potongan" name="potongan" type="number" class="form-control" aria-required="true" aria-invalid="false" placeholder="Masukkan Potongan Harga">
                                </div>
                                <div>
