                ...
                <div id="content_add" class="col-sm-8 col-lg-8">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col">Edit Group Modul Buku</div>
                                <div class="col text-right">
                                    <a href="<?=base_url()?>admin/group-buku/<?=$id_buku?>" class="btn btn-sm btn-outline-secondary">Kembali</a>
                                </div>
                            </div>
                        </div>
                        <form id="formadd" name="formadd" action="<?php echo base_url(); ?>website/lembaga/Management/submit_edit_group_buku_setting" method="post">
                        <input type="hidden" id="csrf-hash-form" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none">
                        <input type="hidden" id="id_config_group" name="id_config_group" value="<?=$id_config_group?>">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input id="name" name="name" type="text" class="form-control" aria-required="true" aria-invalid="false" placeholder="Masukkan Group Modul" value="<?=$config_group->name?>" required>
                            </div>
                            <div>
