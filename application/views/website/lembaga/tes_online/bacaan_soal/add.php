        ...
        <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col">Tambah Bacaan Soal</div>
                        ...
                        <input type="hidden" id="id_paket_soal" name="id_paket_soal" value="<?=$id_paket_soal?>" style="display: none" required>
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-lg-9">
                                        <div class="form-group">
                                            <input id="kode_bacaan" name="kode_bacaan" type="text" class="form-control" aria-required="true" aria-invalid="false" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-lg-9">
                                        <div class="form-group">
                                            <textarea class="summernote note-math-dialog" id="summernote" name="bacaan" rows='10'></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-3">
