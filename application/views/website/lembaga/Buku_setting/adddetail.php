                            ...
                            <div id="content_add" class="col-sm-12 col-lg-4">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <input id="materi" name="skorid" class="control-label mb-1" value="<?php echo $data_id; ?>">
                                            <div class="form-group">
                                                <label for="nama" class="control-label mb-1">Skor Asal</label>
                                                <small for="nama" id="materi_er" class="bg-danger text-white"></small>
                                                <input id="materi" name="skorasal" type="text" class="form-control" aria-required="true" aria-invalid="false" placeholder="Masukkan Skor Asal Konversi">
                                            </div>
                                            <div class="form-group">
                                                <label for="nama" class="control-label mb-1">Hasil skor Konversi</label>
                                                <small for="nama" id="materi_er" class="bg-danger text-white"></small>
                                                <input id="materi" name="skorkonversi" type="text" class="form-control" aria-required="true" aria-invalid="false" placeholder="Masukkan Skor Konversi">
                                            </div>
                                            <div>
