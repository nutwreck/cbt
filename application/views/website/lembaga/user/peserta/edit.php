                                ...
                                <div class="col-sm-12 col-lg-9">
                                    <div class="form-group">
                                        <select class="form-control selectpicker" data-live-search="true" data-width="auto" name="group_peserta">
                                            <option data-tokens="<?=$participants->group_peserta_name != '' ? $participants->group_peserta_name : ''?>" value="<?=$participants->group_peserta_id != 0 ? $participants->group_peserta_id : ''?>" selected><?=$participants->group_peserta_name != '' ? $participants->group_peserta_name : ''?></option>
